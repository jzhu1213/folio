...
export const tailwindTokens = {
  colors: {
    background: 'var(--bg)', surface: 'var(--surface)', 'surface-raised': 'var(--surface-raised)',
    'surface-overlay': 'var(--surface-overlay)', text: 'var(--text)', 'text-sub': 'var(--sub)',
    'text-muted': 'var(--muted)', accent: 'var(--accent)', success: 'var(--success)',
    warning: 'var(--warning)', danger: 'var(--danger)', border: 'var(--border-default)',
    t: { bg: 'var(--bg)', surface: 'var(--surface)', raised: 'var(--surface-raised)', text: 'var(--text)', sub: 'var(--sub)', muted: 'var(--muted)', accent: 'var(--accent)' },
  },
  spacing: designTokens.spacing,
  borderRadius: { sm: 'var(--radius-sm)', md: 'var(--radius-md)', lg: 'var(--radius-lg)', full: 'var(--radius-full)' },
  boxShadow: { none: 'var(--shadow-none)', sm: 'var(--shadow-sm)', md: 'var(--shadow-md)', lg: 'var(--shadow-lg)', glow: 'var(--shadow-glow)' },
